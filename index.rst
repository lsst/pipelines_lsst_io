...
We are building the Science Pipelines for the `Legacy Survey of Space and Time (LSST) <http://lsst.org>`_, but our command-line task and Python API can be extended for any optical or near-infrared dataset.
