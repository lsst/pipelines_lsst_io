...
.. |eups-tag| replace:: v29_0_1
.. |eups-tag-mono| replace:: ``v29_0_1``
.. |eups-tag-bold| replace:: **v29_0_1**
"""

# Patch EUPS and Git tag context for Jinja templating
jinja_contexts = {
    "default": {
        "release_eups_tag": "v29_0_1",
        "release_git_ref": "29.0.1",
        "version": "v29_0_1",
        "release": "v29_0_1",
        "scipipe_conda_ref": "29.0.1",
        "pipelines_demo_ref": "29.0.1",
    }
}
