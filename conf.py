...
.. |eups-tag| replace:: v24_1_7_
.. |eups-tag-mono| replace:: ``v24_1_7``
.. |eups-tag-bold| replace:: **v24_1_7**
"""

# Patch EUPS and Git tag context for Jinja templating
jinja_contexts = {
    "default": {
        "release_eups_tag": "v24_1_7",
        "release_git_ref": "24.1.7",
        "version": "v24_1_7",
        "release": "v24_1_7",
        "scipipe_conda_ref": "24.1.7",
        "pipelines_demo_ref": "24.1.7",
        "newinstall_ref": "24.1.7",
    }
}
