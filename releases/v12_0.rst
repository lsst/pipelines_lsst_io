...
See `task documentation <http://doxygen.lsst.codes/stack/doxygen/x_mainDoxyDoc/pipe_base.html>`__ for more information.
See also `How to Write a Task <http://doxygen.lsst.codes/stack/doxygen/x_mainDoxyDoc/pipe_tasks_write_task.html>`__ for guidelines for choosing between using :lclass:`lsst.pex.config.RegistryField` and :lclass:`lsst.pex.config.ConfigurableField` to hold a subtask.
