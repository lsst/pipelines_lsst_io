...
Metadata describing the operation of algorithms within the `multi-band coadd processing framework <http://doxygen.lsst.codes/stack/doxygen/xlink_master_2017_02_27_03.44.55/pipe_tasks_multi_band.html>`_ is now correctly persisted along with their outputs.
