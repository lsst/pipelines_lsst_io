...
.. _release-v19-0-0-config-parallax:
...
Due to approval of RFC-645 by the DM-CCB, the package `obs_sdss` will be removed from the Science Pipelines before the release of version 20.0.0.
