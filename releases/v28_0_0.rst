...
This release is based on the ``w_2024_42`` weekly build with 2 ticket backported.
...
__ http://doxygen.lsst.codes/stack/doxygen/xlink_v28.0.0.rc2_2024_12_06_18.52.06
...
Installation with ``newinstall.sh`` is no longer supported and is replaced by ``lsstinstall``.
