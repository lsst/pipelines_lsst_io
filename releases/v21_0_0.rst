...
- :ref:`release-v21-0-0-deprecate-PosixDataStore`
- :ref:`release-v21-0-0-deprecate-S3Datastore`
...
.. _release-v21-0-0-deprecate-PosixDataStore:

Removal of PosixDataStore
-------------------------

PosixDatastore no longer necessary. Please switch to
lsst.daf.butler.datastores.fileDatastore.FileDatastore and rename configuration file.
Will soon be removed.

.. _release-v21-0-0-deprecate-S3Datastore:

Removal of S3DataStore
----------------------

S3Datastore no longer necessary. Please switch to
lsst.daf.butler.datastores.fileDatastore.FileDatastore and rename configuration file.
Will soon be removed.
