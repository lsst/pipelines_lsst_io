...
First, you'll need to get the Pipelines software.
This page will guide you through an installation using the method we recommend for most users:

.. toctree::

   Installing the LSST Science Pipelines <installation>
